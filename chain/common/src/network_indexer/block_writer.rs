...
/// Component that writes blocks to the network subgraph store.
...
impl BlockWriter {
    ...
    pub fn write(&self, block: impl Block) -> impl Future<Item = BlockPointer, Error = Error> {
...
impl WriteContext {
    ...
    fn write(self, block: impl Block) -> impl Future<Item = BlockPointer, Error = Error> {
        ...
        Box::new(
            ...
            self.set_entity(block.as_ref())
                ...
                .and_then(move |context| {
                    ...
                    let block_ptr = BlockPointer::from(&block_for_store.block);
