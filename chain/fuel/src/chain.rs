use graph::{
    ...
    blockchain::{
        ...
        BlockchainBuilder, BlockchainKind, EmptyNodeCapabilities, IngestorError, RuntimeAdapter as RuntimeAdapterTrait,
    },
...
use graph::blockchain::{NoopDecoderHook, NoopRuntimeAdapter};
