...
impl blockchain::DataSource<Chain> for DataSource {
    ...
    fn validate(&self) -> Vec<Error> {
        ...
        // Validate that there are no more than one of both block handlers and receipt
        // handlers
...
impl TryFrom<DataSourceTemplateInfo<Chain>> for DataSource {
    ...
    fn try_from(_info: DataSourceTemplateInfo<Chain>) -> Result<Self, Error> {
        ...
        // How this might be implemented if/when Near gets support for
        // templates: let DataSourceTemplateInfo {
        //     template,
        //     params,
        //     context,
        //     creation_block,
        ...
        //     .with_context(|| {
        //         format!(
        //             "Failed to create data source from template `{}`: account
        // parameter is missing",             template.name
        //         )
        //     })?
        //     .clone();
