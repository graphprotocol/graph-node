...
// }
//
// pub type HostModules<T> = Vec<Arc<dyn HostModule<MemoryManager = T>>>;
//
// /// Common trait for runtime host implementations.
// #[async_trait]
// pub trait RuntimeHost: Send + Sync + Debug + 'static {
//     type MemoryManager: Sized + 'static;
//
...
//     type Host: RuntimeHost<MemoryManager = Self::MemoryManager>;
...
//         host_modules: Arc<HostModules<Self::MemoryManager>>,
//         logger: Logger,
//         subgraph_id: SubgraphDeploymentId,
//         metrics: Arc<HostMetrics>,
