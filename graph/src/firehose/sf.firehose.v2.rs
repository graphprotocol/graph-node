...
pub mod info_response {
    ...
    impl BlockIdEncoding {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unset => "BLOCK_ID_ENCODING_UNSET",
                Self::Hex => "BLOCK_ID_ENCODING_HEX",
                Self::BlockIdEncoding0xHex => "BLOCK_ID_ENCODING_0X_HEX",
                Self::Base58 => "BLOCK_ID_ENCODING_BASE58",
                Self::Base64 => "BLOCK_ID_ENCODING_BASE64",
                Self::Base64url => "BLOCK_ID_ENCODING_BASE64URL",
            }
        }
