...
pub use asc_heap::{
    AscHeap, FromAscObj, ToAscObj, asc_get, asc_new, asc_new_or_missing, asc_new_or_null,
};
...
pub enum IndexForAscTypeId {
    ...
    // Discriminant space [1,500, 2,499] was reserved for Cosmos, which has been removed
