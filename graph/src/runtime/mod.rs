...
pub enum IndexForAscTypeId {
    ...
    NearCurveKindEnum = 60,
    NearAccessKeyPermissionKindEnum = 61,
    NearActionKindEnum = 62,
    NearSuccessStatusKindEnum = 63,
    NearDirectionEnum = 64,
    NearSignature = 65,
    NearPublicKey = 66,
    NearFunctionCallPermission = 67,
    NearFullAccessPermission = 68,
    NearAccessKeyPermissionValue = 69,
    NearAccessKey = 70,
    NearDataReceiver = 71,
    ...
    NearActionValue = 80,
    NearActionReceipt = 81,
    NearSuccessStatus = 82,
    NearMerklePathItem = 83,
    ...
    //
    // ```
    // cat chain/tendermint/src/runtime/generated.rs | grep IndexForAscTypeId::Tendermint | grep -Eo "Tendermint[a-zA-Z0-9]+" | awk '{for(x=1;x<=NF;x++)sub(/$/,"="++i+90",")}1' | sed 's/=/ = /'
    // ```
    //
    // The `90` literal at the end in the `awk` should be replaced with the last element
    // value in the list above.
    TendermintArrayEventDataTx = 91,
    TendermintArrayEvent = 92,
    TendermintArrayValidator = 93,
    TendermintArrayCommitSig = 94,
    TendermintArrayBytes = 95,
    TendermintArrayEvidence = 96,
    TendermintArrayEventAttribute = 97,
    TendermintBlockIDFlagEnum = 98,
    TendermintSignedMsgTypeEnum = 99,
    TendermintEventList = 100,
    TendermintEventDataNewBlock = 101,
    TendermintResponseBeginBlock = 102,
    TendermintResponseEndBlock = 103,
    TendermintConsensusParams = 104,
    TendermintVersion = 105,
    TendermintBlock = 106,
    TendermintCommit = 107,
    TendermintCommitSig = 108,
    TendermintEventDataNewBlockHeader = 109,
    TendermintHeader = 110,
    TendermintConsensus = 111,
    TendermintBlockID = 112,
    TendermintPartSetHeader = 113,
    TendermintData = 114,
    TendermintEvidence = 115,
    TendermintDuplicateVoteEvidence = 116,
    TendermintEventDataTx = 117,
    TendermintEventDataVote = 118,
    TendermintLightClientAttackEvidence = 119,
    TendermintLightBlock = 120,
    TendermintValidatorSet = 121,
    TendermintSignedHeader = 122,
    TendermintEvidenceList = 123,
    TendermintValidator = 124,
    TendermintPublicKey = 125,
    TendermintTxResult = 126,
    TendermintResponseDeliverTx = 127,
    TendermintEvent = 128,
    TendermintEventAttribute = 129,
    TendermintEventDataRoundState = 130,
    TendermintEventDataNewRound = 131,
    TendermintValidatorInfo = 132,
    TendermintAddress = 133,
    TendermintEventDataCompleteProposal = 134,
    TendermintEventDataValidatorSetUpdates = 135,
    TendermintEventDataString = 136,
    TendermintEventDataBlockSyncStatus = 137,
    TendermintEventDataStateSyncStatus = 138,
    TendermintTimestamp = 139,
    Tendermintfig = 140,
}
