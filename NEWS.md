...
- `_meta.block.timestamp` is now available for all EVM chains. [#3738](https://github.com/graphprotocol/graph-node/pull/3738), [#3902](https://github.com/graphprotocol/graph-node/pull/3902)
...
- Experimental support for GraphQL API versionining has landed. [#3185](https://github.com/graphprotocol/graph-node/pull/3185)
