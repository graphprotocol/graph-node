...
pub struct IndexNodeServer<Q, S, R, BStore, St> {
    logger: Logger,
...
impl<Q, S, R, BStore, St> IndexNodeServer<Q, S, R, BStore, St> {
...
impl<Q, S, R, BStore, St> IndexNodeServerTrait for IndexNodeServer<Q, S, R, BStore, St>
where
    Q: GraphQlRunner,
    S: StatusStore,
    R: LinkResolver,
