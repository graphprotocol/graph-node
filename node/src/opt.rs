...
pub struct Opt {
    ...
    #[structopt(
        long,
        min_values=0,
        required_unless_one = &["substrate-rpc","ethereum-ws", "ethereum-ipc", "config"],
        conflicts_with_all = &["substrate-rpc","ethereum-ws", "ethereum-ipc", "config"],
    ...
    #[structopt(long, min_values=0,
        required_unless_one = &["substrate-rpc","ethereum-rpc", "ethereum-ipc", "config"],
        conflicts_with_all = &["ethereum-rpc", "ethereum-ipc", "config"],
        value_name="NETWORK_NAME:URL",
        env="SUBSTRATE_RPC",
        help= "Substrate network name (e.g. 'mainnet'), and an Substrate WebSocket URL, separated by a ':'",
    )]
    pub substrate_rpc: Vec<String>,
    #[structopt(long, min_values=0,
    required_unless_one = &["substrate-rpc","ethereum-rpc", "ethereum-ipc", "config"],
    conflicts_with_all = &["substrate-rpc", "ethereum-rpc", "ethereum-ipc", "config"],
    value_name="NETWORK_NAME:[CAPABILITIES]:URL",
    env="ETHEREUM_WS",
    ...
    #[structopt(long, min_values=0,
        required_unless_one = &["substrate-rpc","ethereum-rpc", "ethereum-ws", "config"],
        conflicts_with_all = &["substrate-rpc","ethereum-rpc", "ethereum-ws", "config"],
