...
pub struct Opt {
    ...
    #[structopt(
        ...
        env="ETHEREUM_RPC",
        help= "Ethereum network name (e.g. 'mainnet'), comma-seperated capabilities (eg `full,archive), and a Ethereum RPC URL, separated by a ':'",
    )]
    ...
    #[structopt(long, min_values=0,
        ...
        value_name="NETWORK_NAME:CAPABILITIES:URL",
        env="ETHEREUM_WS",
        help= "Ethereum network name (e.g. 'mainnet'), comma-seperated capabilities (eg `full,archive), and a Ethereum WebSocket URL, separated by a ':'",
    )]
    ...
    #[structopt(long, min_values=0,
        ...
        env="ETHEREUM_IPC",
        help= "Ethereum network name (e.g. 'mainnet'), comma-seperated capabilities (eg `full,archive), and a Ethereum IPC pipe, separated by a ':'",
    )]
