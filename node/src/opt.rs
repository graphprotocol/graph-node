...
pub struct Opt {
    ...
    #[structopt(
        ...
        value_name="NETWORK_NAME:[CAPABILITIES]:URL[,GENESIS_BLOCK_NUMBER]",
        env="ETHEREUM_RPC",
        help= "Ethereum network name (e.g. 'mainnet'), optional comma-seperated capabilities (eg 'full,archive'), and an Ethereum RPC URL and optional comma-seperated genesis block number, separated by a ':'",
    )]
    ...
    #[structopt(long, min_values=0,
        ...
        value_name="NETWORK_NAME:[CAPABILITIES]:URL[,GENESIS_BLOCK_NUMBER]",
        env="ETHEREUM_WS",
        help= "Ethereum network name (e.g. 'mainnet'), optional comma-seperated capabilities (eg 'full,archive`, and an Ethereum WebSocket URL and optional comma-seperated genesis block number, separated by a ':'",
    )]
    ...
    #[structopt(long, min_values=0,
        ...
        value_name="NETWORK_NAME:[CAPABILITIES]:FILE[,GENESIS_BLOCK_NUMBER]",
        env="ETHEREUM_IPC",
        help= "Ethereum network name (e.g. 'mainnet'), optional comma-seperated capabilities (eg 'full,archive'), and an Ethereum IPC pipe and optional comma-seperated genesis block number, separated by a ':'",
    )]
