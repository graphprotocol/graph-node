...
pub struct CopyState {
    ...
    pub target_block_number: i32,
    pub started_at: UtcDateTime,
    pub finished_at: Option<UtcDateTime>,
    pub cancelled_at: Option<UtcDateTime>,
}
...
pub struct StatusResult {
    pub state: Option<(CopyState, Vec<CopyTableState>, OnSync)>,
    pub shard: Shard,
...
pub fn status(
    ...
    let state = CopyState::find(&pools, &shard, dst)?;
