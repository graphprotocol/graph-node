...
impl LatestBlocks {
    pub(super) async fn load<NC>(cx: &Context<NC>) -> Result<Self, Error>
    where
        NC: Client,
    {
    ...
    pub(super) fn filter_completed<NC>(self, cx: &Context<NC>) -> Self
    where
        NC: Client,
    {
    ...
    pub(super) async fn changed<NC>(self, cx: &Context<NC>) -> Result<(), Error>
    where
        NC: Client,
    {
...
async fn latest_block_changed<NC>(
    cx: &Context<NC>,
    dataset: &Ident,
    table: &Ident,
