    ...
    T: RuntimeHostBuilder<C>,
{
    ...
    /// Pipeline Stage 5: Persist block state to the store.
    ///
    /// Wraps the transaction of block state including entity modifications,
    /// offchain modifications, and processed data sources.
