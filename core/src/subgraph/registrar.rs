...
// Auto graft dependencies are synced up to this depth.
    ...
    SM: SubscriptionManager,
{
    ...
    pub fn subgraph_logger(&self, deployment: &DeploymentLocator) -> Logger {
        self.logger.new(o!(
            "subgraph_id" => deployment.hash.to_string(),
    ...
    pub async fn resolve_raw_manifest(
        &self,
        hash: &DeploymentHash,
...
pub async fn create_subgraph_version<
    C: Blockchain,
    S: SubgraphStore,
    P: SubgraphAssignmentProviderTrait,
>(
