...
/// Gas cost for calling gas.consume (so meta)
...
/// the dominant cost that causes this to go over the limit.
pub const CONSUME_GAS_COST: u64 = 100_000;

// Allow up to 25,000 ethereum calls
pub const ETHEREUM_CALL_GAS: u64 = MAX_GAS / 25000;

// The cost of allocating an AscHeap object
pub const ALLOC_NEW_BASE_COST: u64 = 100_000;
pub const ALLOC_NEW_BYTE_COST: u64 = 200;
pub const HEAP_READ_BASE_COST: u64 = 10_000;
pub const HEAP_READ_BYTE_COST: u64 = 100;
