...
async fn unbounded_loop() {
    fn v0_0_4() {
        ...
        let module = test_valid_module_and_store_with_timeout(
            "unboundedLoop",
            mock_data_source("non_terminating.wasm", API_VERSION_0_0_4),
            API_VERSION_0_0_4,
    ...
    fn v0_0_5() {
        ...
        let module = test_valid_module_and_store_with_timeout(
            "unboundedLoop",
            mock_data_source("non_terminating.wasm", API_VERSION_0_0_5),
            API_VERSION_0_0_5,
            Some(Duration::from_secs(3)),
        )
        .0;
...
async fn abi_array() {
    fn v0_0_4() {
        let mut module = test_module(
            "abiArray",
            mock_data_source("abi_classes.wasm", API_VERSION_0_0_4),
            API_VERSION_0_0_4,
        );
        ...
        let new_vec_obj: AscPtr<Array<AscPtr<AscString>>> =
            module.invoke_export("test_array", vec_obj);
    ...
    fn v0_0_5() {
        let mut module = test_module(
            "abiArray",
            mock_data_source("abi_classes.wasm", API_VERSION_0_0_5),
            API_VERSION_0_0_5,
        );
...
async fn abi_bytes_and_fixed_bytes() {
    fn v0_0_4() {
        ...
        let new_vec_obj: AscPtr<Uint8Array> =
            module.invoke_export2("concat", bytes1_ptr, bytes2_ptr);
...
async fn abi_ethabi_token_identity() {
    fn v0_0_4() {
        let mut module = test_module(
            ...
            mock_data_source("abi_token.wasm", API_VERSION_0_0_4),
            API_VERSION_0_0_4,
        );
    ...
    fn v0_0_5() {
        let mut module = test_module(
            "abiEthabiTokenIdentity",
            mock_data_source("abi_token.wasm", API_VERSION_0_0_5),
            API_VERSION_0_0_5,
        );
...
async fn abi_store_value() {
    ...
    fn v0_0_4() {
        let mut module = test_module(
            "abiStoreValue",
            mock_data_source("abi_store_value.wasm", API_VERSION_0_0_4),
            API_VERSION_0_0_4,
        );
    ...
    fn v0_0_5() {
        let mut module = test_module(
            "abiStoreValue",
            mock_data_source("abi_store_value.wasm", API_VERSION_0_0_5),
            API_VERSION_0_0_5,
        );
...
async fn abi_h160_v0_0_4() {
    fn v0_0_4() {
        ...
        let new_address_obj: AscPtr<Uint8Array> =
            module.invoke_export("test_address", array_buffer);
...
async fn big_int_to_string() {
    fn v0_0_4() {
        let mut module = test_module(
            "bigIntToString",
            mock_data_source("big_int_to_string.wasm", API_VERSION_0_0_4),
            API_VERSION_0_0_4,
        );
    ...
    fn v0_0_5() {
        let mut module = test_module(
            "bigIntToString",
            mock_data_source("big_int_to_string.wasm", API_VERSION_0_0_5),
            API_VERSION_0_0_5,
        );
