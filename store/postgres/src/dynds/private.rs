...
pub(crate) struct DataSourcesTable {
    ...
    qname: String,
    table: DynTable,
    block_range: DynColumn<sql_types::Range<i32>>,
...
impl DataSourcesTable {
    ...
    pub(crate) fn new(namespace: String) -> Self {
        ...
        DataSourcesTable {
            ...
            namespace,
            block_range: table.column::<sql_types::Range<i32>, _>("block_range"),
            manifest_idx: table.column::<Integer, _>("manifest_idx"),
            params: table.column::<Jsonb, _>("params"),
            context: table.column::<Jsonb, _>("context"),
            table,
        }
    }
