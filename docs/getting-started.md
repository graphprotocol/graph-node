...
The ABI JSON file must contain the correct ABI to source all the events or any contract state you wish to inject into the Graph Node. There are a few ways to obtain an ABI for the contract:
